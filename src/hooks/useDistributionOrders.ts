...
// useCompleteRoomDelivery removed in distribution lifecycle v2 (1.1.15).
// The legacy `complete_room_delivery` RPC has been dropped; use
// `deliver_stop` + `close_route_if_complete` instead.
