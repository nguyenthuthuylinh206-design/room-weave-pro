...
export function VendorFormPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={isEdit ? 'Sửa đơn vị giặt' : 'Thêm đơn vị giặt'}
        description={isEdit ? vendor?.name : 'Thêm đơn vị giặt là mới'}
      >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <FormField
                  control={form.control}
                  name="contract_info.price_per_kg"
                  render={({ field }) => (
                    <FormItem>
                ...
                <FormField
                  control={form.control}
                  name="contract_info.minimum_order_kg"
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Đơn vị: kg</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <FormField
                  control={form.control}
                  name="contract_info.payment_terms"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Điều khoản thanh toán</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="VD: 30 ngày" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  control={form.control}
                  name="contract_info.delivery_time"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Thời gian giao hàng</FormLabel>
                      <FormControl>
                        <Input {...field} placeholder="VD: 2 ngày" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <FormField
                  control={form.control}
                  name="contract_info.contract_start"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Hợp đồng từ ngày</FormLabel>
                      <FormControl>
                ...
                <FormField
                  control={form.control}
                  name="contract_info.contract_end"
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Hợp đồng đến ngày</FormLabel>
                      <FormControl>
                        <Input type="date" {...field} />
                      </FormControl>
                      <FormMessage />
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Textarea
                        {...field}
                        placeholder="Thêm ghi chú về đơn vị giặt..."
                        rows={4}
                      />
                    </FormControl>
                    <FormMessage />
