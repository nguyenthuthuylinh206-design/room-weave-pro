...
|---|---|---|---|---|---|
| `_add` | text, integer | integer | sql |  | 0 |
| `_alike` | boolean, anyelement, text, text | text | plpgsql |  | 0 |
| `_ancestor_of` | name, name, integer | boolean | sql |  | 0 |
...
| `_cast_exists` | name, name | boolean | sql |  | 0 |
...
| `_col_is_null` | name, name, name, text, boolean | text | plpgsql |  | 0 |
...
| `_definer` | name, name, name[] | boolean | sql |  | 0 |
| `_dexists` | name, name | boolean | sql |  | 0 |
...
| `_extensions` | – | SETOF name | sql |  | 0 |
| `_extras` | character, name[] | name[] | sql |  | 0 |
| `_finish` | integer, integer, integer, boolean DEFAULT NULL::boolean | SETOF text | plpgsql |  | 0 |
| `_fkexists` | name, name[] | boolean | sql |  | 0 |
| `_fprivs_are` | text, name, name[], text | text | plpgsql |  | 0 |
| `_func_compare` | name, name, boolean, text | text | sql |  | 0 |
...
| `_get_latest` | text | integer[] | plpgsql |  | 0 |
| `_get_note` | integer | text | plpgsql |  | 0 |
| `_get_opclass_owner` | name, name | name | sql |  | 0 |
| `_get_rel_owner` | character, name | name | sql |  | 0 |
...
| `_relcomp` | text, text, text, text, text | text | plpgsql |  | 0 |
| `_relexists` | name | boolean | sql |  | 0 |
| `_relne` | text, anyarray, text, text | text | sql |  | 0 |
| `_returns` | name, name[] | text | sql |  | 0 |
| `_rexists` | character, name, name | boolean | sql |  | 0 |
...
| `_set` | text, integer | integer | sql |  | 0 |
| `_strict` | name, name[] | boolean | sql |  | 0 |
...
| `_type_func` | "char", name | boolean | sql |  | 0 |
| `_types_are` | name, name[], text, character[] | text | sql |  | 0 |
| `_unalike` | boolean, anyelement, text, text | text | plpgsql |  | 0 |
| `_vol` | name, name, name[] | text | sql |  | 0 |
...
| `any_column_privs_are` | name, name, name, name[], text | text | plpgsql |  | 0 |
...
| `bag_eq` | text, anyarray, text | text | sql |  | 0 |
| `bag_has` | text, text, text | text | sql |  | 0 |
| `bag_hasnt` | text, text | text | sql |  | 0 |
| `bag_ne` | text, anyarray | text | sql |  | 0 |
...
| `check_test` | text, boolean, text, text | SETOF text | sql |  | 0 |
...
| `cmp_ok` | anyelement, text, anyelement | text | sql |  | 0 |
| `col_default_is` | name, name, name, text, text | text | sql |  | 0 |
| `col_has_check` | name, name, name, text | text | sql |  | 0 |
| `col_has_default` | name, name | text | sql |  | 0 |
| `col_hasnt_default` | name, name, text | text | plpgsql |  | 0 |
| `col_is_fk` | name, name, name[], text | text | plpgsql |  | 0 |
| `col_is_null` | schema_name name, table_name name, column_name name, description text DEFAULT NU | text | sql |  | 0 |
| `col_is_pk` | name, name[], text | text | sql |  | 0 |
| `col_is_unique` | name, name, text | text | sql |  | 0 |
| `col_isnt_fk` | name, name, text | text | sql |  | 0 |
| `col_isnt_pk` | name, name, name[], text | text | sql |  | 0 |
| `col_not_null` | table_name name, column_name name, description text DEFAULT NULL::text | text | sql |  | 0 |
| `col_type_is` | name, name, name, name, text, text | text | plpgsql |  | 0 |
| `collect_tap` | character varying[] | text | sql |  | 0 |
| `column_privs_are` | name, name, name, name, name[], text | text | plpgsql |  | 0 |
| `columns_are` | name, name[], text | text | sql |  | 0 |
...
| `composite_owner_is` | name, name | text | sql |  | 0 |
...
| `confirm_receive_order` | p_order_id uuid | jsonb | plpgsql | ✓ | 1 |
...
| `create_laundry_loss_transaction` | p_tenant_id uuid, p_hotel_id uuid, p_created_by uuid, p_items jsonb, p_loss_type | jsonb | plpgsql | ✓ | 1 |
| `create_laundry_return_transaction` | p_tenant_id uuid, p_hotel_id uuid, p_from_location text, p_to_location text, p_c | jsonb | plpgsql | ✓ | 1 |
...
| `database_privs_are` | name, name, name[] | text | sql |  | 0 |
...
| `do_tap` | name | SETOF text | sql |  | 0 |
| `doesnt_imatch` | anyelement, text, text | text | sql |  | 0 |
| `doesnt_match` | anyelement, text, text | text | sql |  | 0 |
| `domain_type_is` | name, text, name, text, text | text | plpgsql |  | 0 |
| `domain_type_isnt` | name, text, text | text | sql |  | 0 |
...
| `enum_has_labels` | name, name[] | text | sql |  | 0 |
| `enums_are` | name, name[] | text | sql |  | 0 |
| `extensions_are` | name[] | text | sql |  | 0 |
| `fail` | text | text | sql |  | 0 |
| `fdw_privs_are` | name, name, name[] | text | sql |  | 0 |
| `findfuncs` | name, text | text[] | sql |  | 0 |
| `finish` | exception_on_failure boolean DEFAULT NULL::boolean | SETOF text | sql |  | 0 |
| `fk_ok` | name, name, name, name | text | sql |  | 0 |
...
| `foreign_table_owner_is` | name, name | text | sql |  | 0 |
| `foreign_tables_are` | name[] | text | sql |  | 0 |
| `function_lang_is` | name, name, name | text | sql |  | 0 |
| `function_owner_is` | name, name[], name | text | sql |  | 0 |
| `function_privs_are` | name, name[], name, name[], text | text | sql |  | 0 |
| `function_returns` | name, name, name[], text | text | sql |  | 0 |
| `functions_are` | name, name[] | text | sql |  | 0 |
...
| `get_categories_with_stats` | p_tenant_id uuid | TABLE(id uuid, name text, name_en text,  | plpgsql | ✓ | 1 |
...
| `get_monthly_expenses` | p_tenant_id uuid, p_months integer, p_hotel_id uuid DEFAULT NULL::uuid | TABLE(month text, purchase bigint, laund | plpgsql | ✓ | 1 |
...
| `get_recent_activities` | p_tenant_id uuid, p_limit integer DEFAULT 10 | TABLE(id uuid, type text, description te | plpgsql | ✓ | 1 |
...
| `handover_batch` | p_batch_id uuid, p_actor_id uuid DEFAULT NULL::uuid, p_adjustments jsonb DEFAULT | jsonb | plpgsql | ✓ | 1 |
...
| `has_cast` | name, name | text | sql |  | 0 |
| `has_check` | name, name, text | text | sql |  | 0 |
| `has_column` | name, name | text | sql |  | 0 |
| `has_composite` | name, text | text | sql |  | 0 |
| `has_domain` | name, name, text | text | sql |  | 0 |
| `has_enum` | name, name, text | text | sql |  | 0 |
| `has_extension` | name, name, text | text | sql |  | 0 |
| `has_fk` | name, name, text | text | sql |  | 0 |
| `has_foreign_table` | name, name, text | text | sql |  | 0 |
| `has_function` | name, name, text | text | sql |  | 0 |
| `has_group` | name, text | text | sql |  | 0 |
| `has_index` | name, name, name | text | plpgsql |  | 0 |
| `has_inherited_tables` | name | text | sql |  | 0 |
| `has_language` | name | text | sql |  | 0 |
| `has_leftop` | name, name, name, name, text | text | sql |  | 0 |
| `has_materialized_view` | name | text | sql |  | 0 |
| `has_opclass` | name, name, text | text | sql |  | 0 |
| `has_operator` | name, name, name, name | text | sql |  | 0 |
...
| `has_rule` | name, name | text | sql |  | 0 |
| `has_schema` | name | text | sql |  | 0 |
| `has_sequence` | name, text | text | sql |  | 0 |
| `has_table` | name, name, text | text | sql |  | 0 |
| `has_tablespace` | name, text | text | sql |  | 0 |
| `has_trigger` | name, name | text | sql |  | 0 |
| `has_type` | name, name, text | text | sql |  | 0 |
| `has_unique` | text, text | text | sql |  | 0 |
| `has_user` | name, text | text | sql |  | 0 |
...
| `has_view` | name | text | sql |  | 0 |
| `hasnt_cast` | name, name, name | text | sql |  | 0 |
| `hasnt_column` | name, name | text | sql |  | 0 |
...
| `hasnt_fk` | name, text | text | sql |  | 0 |
| `hasnt_foreign_table` | name, text | text | sql |  | 0 |
| `hasnt_function` | name | text | sql |  | 0 |
| `hasnt_group` | name, text | text | sql |  | 0 |
| `hasnt_index` | name, name, name | text | sql |  | 0 |
| `hasnt_inherited_tables` | name, name, text | text | sql |  | 0 |
| `hasnt_language` | name, text | text | sql |  | 0 |
| `hasnt_leftop` | name, name | text | sql |  | 0 |
| `hasnt_materialized_view` | name, name, text | text | sql |  | 0 |
| `hasnt_opclass` | name | text | sql |  | 0 |
| `hasnt_operator` | name, name, name, text | text | sql |  | 0 |
| `hasnt_pk` | name | text | sql |  | 0 |
| `hasnt_relation` | name, name, text | text | sql |  | 0 |
| `hasnt_rightop` | name, name, text | text | sql |  | 0 |
| `hasnt_role` | name | text | sql |  | 0 |
| `hasnt_rule` | name, name, name, text | text | sql |  | 0 |
| `hasnt_schema` | name, text | text | sql |  | 0 |
| `hasnt_sequence` | name, text | text | sql |  | 0 |
| `hasnt_table` | name | text | sql |  | 0 |
| `hasnt_tablespace` | name | text | sql |  | 0 |
| `hasnt_trigger` | name, name, name | text | sql |  | 0 |
| `hasnt_type` | name, name | text | sql |  | 0 |
| `hasnt_user` | name, text | text | sql |  | 0 |
| `hasnt_view` | name, text | text | sql |  | 0 |
...
| `index_is_primary` | name | text | plpgsql |  | 0 |
| `index_is_type` | name, name, name, name, text | text | plpgsql |  | 0 |
| `index_is_unique` | name, name, name | text | sql |  | 0 |
| `index_owner_is` | name, name, name, name, text | text | plpgsql |  | 0 |
| `indexes_are` | name, name[] | text | sql |  | 0 |
...
| `is` | anyelement, anyelement, text | text | plpgsql |  | 0 |
| `is_aggregate` | name, name[], text | text | sql |  | 0 |
| `is_ancestor_of` | name, name, name, name, integer, text | text | sql |  | 0 |
| `is_clustered` | name, name, name, text | text | plpgsql |  | 0 |
| `is_definer` | name, name[], text | text | sql |  | 0 |
| `is_descendent_of` | name, name, integer, text | text | sql |  | 0 |
...
| `is_member_of` | name, name, text | text | sql |  | 0 |
| `is_normal_function` | name, name[], text | text | sql |  | 0 |
| `is_owner_user` | – | boolean | sql | ✓ | 0 |
| `is_partition_of` | name, name | text | sql |  | 0 |
| `is_partitioned` | name | text | sql |  | 0 |
...
| `is_window` | name, name[] | text | sql |  | 0 |
| `isa_ok` | anyelement, regtype | text | sql |  | 0 |
| `isnt` | anyelement, anyelement, text | text | plpgsql |  | 0 |
| `isnt_aggregate` | name, name | text | sql |  | 0 |
| `isnt_ancestor_of` | name, name, name, name, integer, text | text | sql |  | 0 |
| `isnt_definer` | name, name | text | sql |  | 0 |
| `isnt_descendent_of` | name, name, integer | text | sql |  | 0 |
| `isnt_empty` | text | text | sql |  | 0 |
| `isnt_member_of` | name, name[] | text | sql |  | 0 |
| `isnt_normal_function` | name | text | sql |  | 0 |
| `isnt_partitioned` | name, text | text | sql |  | 0 |
| `isnt_procedure` | name, text | text | sql |  | 0 |
| `isnt_strict` | name, name, name[], text | text | sql |  | 0 |
| `isnt_superuser` | name, text | text | plpgsql |  | 0 |
...
| `language_owner_is` | name, name, text | text | plpgsql |  | 0 |
| `language_privs_are` | name, name, name[] | text | sql |  | 0 |
| `languages_are` | name[] | text | sql |  | 0 |
...
| `matches` | anyelement, text, text | text | sql |  | 0 |
| `materialized_view_owner_is` | name, name, text | text | plpgsql |  | 0 |
| `materialized_views_are` | name, name[] | text | sql |  | 0 |
...
| `opclass_owner_is` | name, name, text | text | plpgsql |  | 0 |
| `opclasses_are` | name[] | text | sql |  | 0 |
| `operators_are` | name, text[] | text | sql |  | 0 |
| `os_name` | – | text | sql |  | 0 |
...
| `performs_ok` | text, numeric, text | text | plpgsql |  | 0 |
...
| `policies_are` | name, name, name[] | text | sql |  | 0 |
| `policy_cmd_is` | name, name, text | text | sql |  | 0 |
| `policy_roles_are` | name, name, name, name[], text | text | sql |  | 0 |
...
| `relation_owner_is` | name, name, text | text | plpgsql |  | 0 |
...
| `results_eq` | text, anyarray, text | text | plpgsql |  | 0 |
| `results_ne` | text, anyarray | text | sql |  | 0 |
...
| `roles_are` | name[] | text | sql |  | 0 |
| `room_items_update_inventory` | – | trigger | plpgsql |  | 0 |
| `row_eq` | text, anyelement | text | sql |  | 0 |
| `rule_is_instead` | name, name, name | text | sql |  | 0 |
| `rule_is_on` | name, name, name, text, text | text | plpgsql |  | 0 |
| `rules_are` | name, name, name[] | text | sql |  | 0 |
| `run_auto_reorder_daily` | – | jsonb | plpgsql | ✓ | 0 |
| `runtests` | name, text | SETOF text | sql |  | 0 |
| `schedule_renewal_reminders` | – | void | plpgsql |  | 1 |
| `schema_owner_is` | name, name, text | text | plpgsql |  | 0 |
| `schema_privs_are` | name, name, name[] | text | sql |  | 0 |
| `schemas_are` | name[], text | text | sql |  | 0 |
| `send_draft_batch` | p_batch_id uuid, p_vendor_id uuid, p_delivery_date date, p_expected_return_date  | jsonb | plpgsql | ✓ | 1 |
| `sequence_owner_is` | name, name, name, text | text | plpgsql |  | 0 |
| `sequence_privs_are` | name, name, name, name[] | text | sql |  | 0 |
| `sequences_are` | name[], text | text | sql |  | 0 |
| `server_privs_are` | name, name, name[] | text | sql |  | 0 |
| `set_eq` | text, anyarray | text | sql |  | 0 |
| `set_has` | text, text | text | sql |  | 0 |
| `set_hasnt` | text, text, text | text | sql |  | 0 |
| `set_ne` | text, text | text | sql |  | 0 |
| `set_tenant_read_only` | p_tenant_id uuid, p_reason text | void | plpgsql | ✓ | 0 |
| `settle_batch_compensation` | _batch_id uuid, _compensation_amount numeric, _notes text DEFAULT NULL::text | jsonb | plpgsql | ✓ | 1 |
...
| `table_privs_are` | name, name, name[], text | text | plpgsql |  | 0 |
| `tables_are` | name[], text | text | sql |  | 0 |
| `tablespace_owner_is` | name, name | text | sql |  | 0 |
| `tablespace_privs_are` | name, name, name[], text | text | plpgsql |  | 0 |
| `tablespaces_are` | name[], text | text | sql |  | 0 |
| `tg_inventory_out_update_reorder` | – | trigger | plpgsql | ✓ | 0 |
| `tg_reorder_suggestions_updated_at` | – | trigger | plpgsql | ✓ | 0 |
| `throws_ilike` | text, text, text | text | plpgsql |  | 0 |
| `throws_imatching` | text, text, text | text | plpgsql |  | 0 |
| `throws_like` | text, text, text | text | plpgsql |  | 0 |
| `throws_matching` | text, text, text | text | plpgsql |  | 0 |
| `throws_ok` | text, integer, text | text | sql |  | 0 |
| `todo` | why text | SETOF boolean | plpgsql |  | 0 |
...
| `volatility_is` | name, name, text, text | text | sql |  | 0 |
...
- `col_is_null`(schema_name name, table_name name, column_name name, descrip)
- `col_is_pk`(name, name[], text)
- `col_is_unique`(name, name, text)
- `col_isnt_fk`(name, name, text)
- `col_isnt_pk`(name, name, name[], text)
- `col_not_null`(table_name name, column_name name, description text DEFAULT )
...
- `hasnt_leftop`(name, name)
- `hasnt_materialized_view`(name, name, text)
- `hasnt_opclass`(name)
- `hasnt_operator`(name, name, name, text)
- `hasnt_pk`(name)
