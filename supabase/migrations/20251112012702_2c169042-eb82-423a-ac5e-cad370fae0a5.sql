-- ============================================
-- FIX: Update complete_registration with CORRECT tenants column names
-- ============================================
...
BEGIN
  ...
  -- 1. Create tenant with CORRECT column names
  INSERT INTO tenants (
    name, 
    email, 
    phone, 
...
COMMENT ON FUNCTION complete_registration IS 'Completes user registration. Fixed to use correct tenants table column names.';