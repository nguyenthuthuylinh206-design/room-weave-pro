-- ============================================
-- FIX: Ensure user exists in public.users before updating
-- ============================================
...
COMMENT ON FUNCTION complete_registration IS 'Fixed: Inserts user into public.users if not exists before creating relationships.';