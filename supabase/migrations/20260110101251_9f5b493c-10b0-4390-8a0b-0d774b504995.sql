-- Filter out adjustment transactions from regular inventory transaction list
-- Adjustment transactions should only be visible in Stock Audit Report
...
begin
  ...
  with filtered_transactions as (
    ...
    where t.tenant_id = p_tenant_id
      and t.transaction_category != 'adjustment'  -- Exclude adjustment transactions
