-- Drop all existing versions of get_rooms_filtered
DROP FUNCTION IF EXISTS public.get_rooms_filtered(uuid, uuid, integer, text, text, text, boolean) CASCADE;
DROP FUNCTION IF EXISTS public.get_rooms_filtered(uuid, uuid, text, text, boolean) CASCADE;
DROP FUNCTION IF EXISTS public.get_rooms_filtered CASCADE;
