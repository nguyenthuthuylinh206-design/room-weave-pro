-- Fix duplicate key in create_distribution_order: UPSERT batch row to coexist with trg_auto_create_batch_records trigger
...
BEGIN
  ...
  -- ★ UPSERT batch row (trigger trg_auto_create_batch_records on distribution_order_rooms may have already created it)
