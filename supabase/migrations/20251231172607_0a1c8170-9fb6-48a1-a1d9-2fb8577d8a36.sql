-- Create new RPC that follows exact same logic as get_room_items_with_standards
-- But for multiple rooms at once, and only returns missing items with stock > 0
